...
{
    resize(850, 550);
    setWindowTitle(tr("Plutonium") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
    ...
    setObjectName("plutoniumApp");
    //setStyleSheet("#plutoniumApp { background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:1, stop:0 #757575, stop:1.0 #979797); } QToolTip { color: #efefef; background-color: #434343;  border:0px;} ");
    setStyleSheet("#plutoniumApp { background-color: #B2B2B2; } QToolTip { color: #efefef; background-color: #434343;  border:0px;} ");
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Plutonium address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About Plutonium"), this);
    aboutAction->setToolTip(tr("Show information about Plutonium"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Plutonium"));
...
void BitcoinGUI::createToolBars()
{
    ...
    toolbar->setStyleSheet("QToolButton { min-width:70px;min-height:36px;color:#182400;border:none;margin:0px;padding:0px;} QToolButton:hover { color: #5CC908; background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:0, y2:1, stop:0 #1B500A, stop:1.0 #354F00); margin:0px; padding:0px; border:none; } QToolButton:checked { color: #5CC908; background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:0, y2:1, stop:0 #1B500A, stop:1.0 #354F00); margin:0px; padding:0px; border-right-color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0, stop:0 #3b3b3b, stop:0.5 #6c6c6f, stop:1.0 #6c6c6f);border-right-width:0px;border-right-style:inset; border-left-color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0, stop:0 #2a2a2a, stop:0.5 #5b5b5e, stop:1.0 #5b5b5e);border-left-width:0px;border-left-style:inset; } QToolButton:pressed { color: #5CC908; background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:0, y2:1, stop:0 #A3BA30, stop:1.0 #3A632A); margin:0px; padding:0px; border:none;} QToolButton:selected { color: #ffffff; background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:0, y2:1, stop:0 #474748, stop:1.0 #353536); margin:0px;padding:0px;border:none; } #tabsToolbar { min-height:48px; color: #b2b2b2; background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:0, y2:1, stop:0 #65924E, stop:1.0 #A3BA30); margin:0px; padding:0px; border-top-color: rgba(160, 160, 160, 191); border-top-width: 1px; border-top-style: inset; } QToolBar::handle { background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:0, y2:1, stop:0 #65924E, stop:1.0 #A3BA30); }");
    toolbar2->setStyleSheet("QToolButton { min-width:70px;min-height:36px;color:#182400;border:none;margin:0px;padding:0px;} QToolButton:hover { color: #5CC908; background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:0, y2:1, stop:0 #1B500A, stop:1.0 #354F00); margin:0px; padding:0px; border:none; } QToolButton:checked { color: #5CC908; background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:0, y2:1, stop:0 #1B500A, stop:1.0 #354F00); margin:0px; padding:0px; border-right-color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0, stop:0 #3b3b3b, stop:0.5 #6c6c6f, stop:1.0 #6c6c6f);border-right-width:0px;border-right-style:inset; border-left-color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0, stop:0 #2a2a2a, stop:0.5 #5b5b5e, stop:1.0 #5b5b5e);border-left-width:0px;border-left-style:inset; } QToolButton:pressed { color: #5CC908; background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:0, y2:1, stop:0 #A3BA30, stop:1.0 #3A632A); margin:0px; padding:0px; border:none;} QToolButton:selected { color: #ffffff; background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:0, y2:1, stop:0 #474748, stop:1.0 #353536); margin:0px;padding:0px;border:none; } #actionsToolbar { min-height:48px; color: #b2b2b2; background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:0, y2:1, stop:0 #65924E, stop:1.0 #A3BA30); margin:0px; padding:0px; border-top-color: rgba(160, 160, 160, 191); border-top-width: 1px; border-top-style: inset; } QToolBar::handle { background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:0, y2:1, stop:0 #65924E, stop:1.0 #A3BA30); }");
}
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Plutonium client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Plutonium client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Plutonium network.", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Plutonium address or malformed URI parameters."));
    }
